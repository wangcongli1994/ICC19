...
So a certificate signed for other purposes may be maliciously used in HTTPS, and accepted by these browsers.
}   % 总结不够到位；我看结果的标准，怎么好像和以前的结果记录有变化？
...
Chrome implements the procedure of name validation,
    ...
    only with the field of commonName but not the extension of Subject Alternative Name (SAN).
