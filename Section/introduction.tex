...
\begin{itemize}
\item
Because Edge and IE consider MD5 and SHA-1 as secure,
    a certificate signed or forged with these weak cryptographic algorithms
...
Meanwhile, all browsers accept server certificates binding an RSA-1024 key pair without any warning,
        which is no longer approved by NIST since 2016 \cite{NIST2005ECC}.
