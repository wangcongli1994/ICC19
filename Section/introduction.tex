...
HTTPS is becoming a de facto protocol used by Web to provide security features including confidentiality, data integrity, and authentication for data transmission between browsers and web servers. It is used hundreds of million of times every day in web browsers \cite{durumeric2013analysis} \cite{felt2017measuring}.
