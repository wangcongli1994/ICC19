...
\item
Chrome, Edge and IE do not process the certificate extensions of Key Usage and Extended Key Usage correctly.
When these extensions appear inconsistently in certificates,
    no warning shows.
...
Chrome implements the procedure of name validation,
    ...
    with the field of Common Name and the extension of Subject Alternative Name.
