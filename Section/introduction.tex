...
\item We thoroughly analyzed various HTTPS errors and HTTPS browser security warnings for mainstream browsers.
    Specifically, HTTPS errors include basic certificate validation error, certificate extension validation error, name validation error, and HTTPS security-enhancement error.
    The mainstream browsers we analyzed contain chrome, firefox, Edge, and IE.
