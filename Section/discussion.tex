...
We must strictly distinguish between server certificate and CA certificate, and we cannot confuse them.
However, when the ca flag field of a server certificate is set to true, Chrome, Edge and IE think it is safe.
