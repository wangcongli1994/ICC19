...
\subsection{\textcolor[rgb]{1.00,0.00,0.00}{Legacy Cryptographic Algorithm}}
...
The ones with SHA-1 or 1024-bit RSA shall be rejected, or trigger Level-B warnings at least.
...
\textcolor[rgb]{1.00,0.00,0.00}{The size of the CRLSet  \cite{CRLSet} file is capped at 250 KB.}
