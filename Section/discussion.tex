...
However, %in our opinion,
    ...
    and Level-A warnings should be suitable.
...
\noindent\textbf{Suggestion.} The same process of name validation should be enforced in different browsers gradually,
...
\noindent\textbf{Suggestion.} HPKP should be supported also with the private certificate store,
