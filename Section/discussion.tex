...
\noindent\textbf{Suggestions:} (\emph{a})Edge and IE should gradually stop accepting certificates signed by MD5 or SHA-1,
    and display Level-B warnings on MD5 and SHA-1.
    (\emph{b})Chrome, Edge, and IE should show \emph{unbypassable} Level-C warnings on 512-bit RSA.
...
\noindent\textbf{Suggestions:} Chrome should collect more revoked certificates that belong to popular websites,
