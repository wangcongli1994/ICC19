...
when the visits violate the HSTS policy. \textcolor[rgb]{1.00,0.00,0.00}{It is better for websites to enable HSTS through the pre-loaded list instead of trust-on-first-use, because the HSTS header can be stripped by the attacker if this is the user's first visit.}
\subsection{HPKP}
