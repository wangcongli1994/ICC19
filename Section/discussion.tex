...
if it does not want to support CRL and OCSP.
...
the Basic Constraints extension in Firefox, and the extensions of Key Usage  and Extended Key Usage in Chrome, Edge and IE.
...
\noindent\textbf{Suggestion.} Show higher-level warnings on complete mismatch,
     because low-cost TLS server certificates are available.

The same process of name validation shall be enforced in different browsers gradually,
