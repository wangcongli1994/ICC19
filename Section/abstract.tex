\begin{abstract}
\mbox{HTTPS\,provides authentication, data\,confidentiality,} and integrity
...
a browser shows security warnings to users,
    when different HTTPS errors happen (e.g.,
...
This paper presents a list of common HTTPS errors,
    and we investigate the browser behaviors on each error.
...
Our study discloses browser defects
