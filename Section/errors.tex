...
the errors of certificate verification, %of basic fields and extensions,
 name validation, and security-enhancement of HTTPS.
...
The following certificate extensions are important
        ...
        and helpful to detect the MitM attacks by forged certificates.
...
There following errors of name validation may happen.
...
Note that,
    it is a complete mismatch,     when a user visits www.foo.com but receives a certificate for abc.foo.com.
