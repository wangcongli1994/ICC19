...
\textcolor[rgb]{1.00,0.00,0.00}{These HTTPS errors can directly cause server certificates to be forged.
HSTS and HPKP are relatively recent HTTPS security-enhancement protocols that implemented by browsers.}
...
The received certificate has been revoked.
...
Note that,
    this is a complete mismatch but not a WWW mismatch,     when the visit to www.foo.com receives a certificate for abc.foo.com.
