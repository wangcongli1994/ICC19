...
\textbf{Untrusted Self-signed Server Certificate.}
    ...
    In general, self-signed server certificates are not trusted by browsers and must be installed manually.
...
\textbf{Extended Key Usage Extension.}
    ...
    all webhost certificates must include "serverAuth" in their extended key usage extension.
