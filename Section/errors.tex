...
A TLS server certificate must include the serverAuth extended key usage. \cite{brubaker2014using}
...
Browsers check
    ...
    through the field of CN and the extension of subject alternative name.
