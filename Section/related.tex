...
\noindent\textbf{HTTPS Adoption.} 
Several studies \cite{DBLP:conf/uss/FeltBKPBT17, Durumeric2014Analysis, Durumeric2013ZMap, Holz2011The}.
have measured HTTPS Adoption on the Web and gain insight into the current state of the HTTPS ecosystem by scanning the IPv4 address space, scanning Alexa websites, capturing TLS/SSL traffic from network links, or browser telemetry.
...
\noindent\textbf{Invalid Certificates.}
...
Some studies of the HTTPS adoption also find a large proportion of invalid certificate in the wild \cite{kumar2018tracking, Chung2016Measuring, Durumeric2014Analysis, Holz2011The}.
%这一段讲FrankenCerts
...
A number of HTTPS security polices have been developed to enhance HTTPS security.
    ...
    Amann et al. \cite{Amann2017Mission} analyze the deployment of HSTS and HPKP in servers.
