...
\noindent\textbf{HTTPS Adoption.} Several studies \cite{DBLP:conf/uss/FeltBKPBT17} \cite{Durumeric2014Analysis} \cite{Durumeric2013ZMap}  \cite{Holz2011The} 
...
%这一段讲 HPKP  HSTS
\noindent\textbf{HSTS and HPKP.} A number of HTTPS security polices have been developed to enhance HTTPS security.
