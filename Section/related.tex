...
\cite{Acer2017Where}    investigated the root causes of HTTPS certificate errors,
...
Compared with these studies focusing on the TLS warnings in the wild,
...
%    As a result, many studies focus on the development of HTTPS security polices.
    \textcolor[rgb]{1.00,0.00,0.00}{Kranch et al. \cite{KranchB15}} and Amann et al. \cite{Amann2017Mission} analyzed the deployment of HSTS and HPKP in web servers,
