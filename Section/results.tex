...
\textcolor[rgb]{1.00,0.00,0.00}{2048-bit RSA and SHA-256 are used in these tests,
    except for the ones of weak key pair and weak hash algorithm.}      %% 这句话描述，对不对？
...
(\emph{b}) \textcolor[rgb]{1.00,0.00,0.00}{CRL. When it is revoked through CRL,
...
When we visit a website in the HSTS pre-loaded list, 
    if there is an HTTPS error that causes Level-B warnings without HSTS (for example,
