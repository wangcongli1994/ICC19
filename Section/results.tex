...
The evaluated browsers are Chrome 67, Firefox62, Edge 42, and IE 11. The results are summarized in Table I.
\begin{table*}[htbp]
\centering
...
\multirow{12}{*}{\begin{tabular}[c]{@{}c@{}}Certificate Extension \\ Validation Error\end{tabular}} & correct CA flag, incorrect PathLenConstraint                                                                      & C                    & Secure               & C                    & B                    \\
...
\multirow{10}{*}{\begin{tabular}[c]{@{}c@{}}HTTPS Security \\ Enhancement Error\end{tabular}}       & HPKP: private srore; first visit: incorrect HPKP header, second visit: correct/incorrect/no HPKP header       & Secure               & Secure               & Secure               & Secure          \\
...
\leftline{B and C represent Level B and Level C in the error warning level. "Secure" means that the browser has not detected an error and prompted a safe browsing }
