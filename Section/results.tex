...
In these tests,
    the field of commonName is set the same as  the SAN extension,
and the SAN extension is non-critical.

Next, the field of CN is set different from the SAN extension,
