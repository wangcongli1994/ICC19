...
2048-bit RSA and SHA-256 are used in these tests,
    except for the ones of weak key pair and weak hash algorithm.      %% 这句话描述，对不对？  对！
...
% & Untrusted self-signed server certificate & B & \textcolor[rgb]{1.00,0.00,0.00}{B[xx]} & B & B \\     % 这里应该有点什么专门的解释说明
 ...
 & Weak key pair (160-bit ECC) & D & D & D & D \\ \cline{2-6}
...
% & ~~incorrect Extended Key Usage, no Key Usage & C & C & C & C \\
 ...
 %新做的实验，三级证书
 & \textcolor[rgb]{0.00,0.00,1.00}{Server certificate, key usage is critical and extended key usage is non-critical} &  &  &  &  \\
 & ~~correct Extended Key Usage, correct/no Key Usage & Secure & Secure & Secure & Secure \\
 & ~~\textcolor[rgb]{0.00,0.00,1.00}{correct Extended Key Usage, incorrect Key Usage} & Secure & \textcolor[rgb]{0.00,0.00,1.00}{C} & Secure & Secure \\
% & ~~correct Extended Key Usage, incorrect Key Usage & Secure & Secure & Secure & Secure \\
% & ~~correct Extended Key Usage, no Key Usage & Secure & Secure & Secure & Secure \\
 & ~~incorrect Extended Key Usage, correct/incorrect/no Key Usage & C & C & C & C \\
% & ~~incorrect Extended Key Usage, incorrect Key Usage & C & C & C & C \\
...
\textcolor[rgb]{1.00,0.00,0.00}{The extensions of Basic Constraints and Key Usage are critical, and
...
Therefore, even if a TLS server holds a certificate where the cA flag is false,
...
If the pathLenConstraint integer of the Basic Constraints extension
    ...
    and the cA flag is false in the intermediate CA certificate (i.e.,
     the pathLenConstraint integer is violated in the certificate chain),
...
It seems that HPKP validation is not enabled.
