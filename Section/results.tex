...
TLS 1.2 is adopted in experiments.
...
It seems that HPKP validation is not activated in this case.

When the root CA is publicly trusted (i.e., Let's Encrypt), there are two categories of experiments.
