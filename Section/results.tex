...
\multirow{11}{*}{\begin{tabular}[c]{@{}c@{}}Name Validation\end{tabular}}
 & \textcolor[rgb]{1.00,0.00,0.00}{Complete mismatch} & B & B & B & B \\  % 这个也是B，与WWW mismatch都一样，不合适！应该讨论
...
\multirow{13}{*}{\begin{tabular}[c]{@{}c@{}}HTTPS Security\\Enhancement\end{tabular}}
 ...
 & HSTS, not in preload list &  &  &  &  \\
 &~~resource over plain HTTP & A & A & A & A \\
 & ~~1st visit: correct HSTS header, 2nd visit: HTTPS error &C & C & C &C \\
 & HSTS, in preload list &  &  &  &  \\
 & ~~resource over plain HTTP & A & A & A & A \\
 & ~~HTTPS error & C &C & C & C \\ \bottomrule
\end{tabular}
...
%总结：只有第一次pin对，第二次pin错的时候才会报错，其他时候都不报错
 ...
 \textbf{HSTS.}
 HSTS follows the trust-on-first-use policy, but HSTS has a preload list in the browsers.
