...
The  attacks might be launched
    ...
    or deceiving browsers to visit the website through plain HTTP.
When such errors happen,
    ...
    because an HTTPS error is not definitely caused by MitM attacks.
...
\begin{figure}[htb]
\centerline{\includegraphics[width=7cm]{Figure/fig1.png}}%记得换成chrome的截图
...
\begin{figure}[htb]
\centerline{\includegraphics[width=7cm]{Figure/fig2.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=7cm]{Figure/fig3.png}}%记得换成自己fireblossom.xyz网址的截图
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=7cm]{Figure/fig4.png}}%截图需要再调整成清晰的
