...
\begin{figure}[!h]
%\setlength{\belowcaptionskip}{-2cm}
%\centerline{\includegraphics[scale=0.4]{Figure/fig2.png}}
\centerline{\includegraphics[scale=0.48]{Figure/fig2.pdf}}
...
\begin{figure}[htbp]
%\setlength{\belowcaptionskip}{-2cm}
%\centerline{\includegraphics[scale=0.4]{Figure/fig3.png}}% 记得换成自己fireblossom.xyz网址的截图
%\centerline{\includegraphics[height=6.58cm,width=6.11cm]{Figure/fig3.pdf}}
\centerline{\includegraphics[scale=0.48]{Figure/fig3.pdf}}
