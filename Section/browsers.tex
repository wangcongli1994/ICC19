...
\textcolor[rgb]{1.00,0.00,0.00}{As shown in Figure \ref{fig-a},
    Chrome displays the visited website with a passive indicator in the address bar.
...
%\centerline{\includegraphics[height=2.4cm,width=7cm]{Figure/fig1.pdf}}% 记得换成chrome的截图
\centerline{\includegraphics[scale=0.6]{Figure/fig1.pdf}}
...
\textcolor[rgb]{1.00,0.00,0.00}{As shown in Figure \ref{fig-b}, 
...
\begin{figure}[!h]
%\setlength{\belowcaptionskip}{-2cm}
%\centerline{\includegraphics[scale=0.5]{Figure/fig2.png}}
\centerline{\includegraphics[height=5.47cm,width=6.15cm]{Figure/fig2.pdf}}
...
\begin{figure}[htbp]
%\setlength{\belowcaptionskip}{-2cm}
%\centerline{\includegraphics[scale=0.5]{Figure/fig3.png}}% 记得换成自己fireblossom.xyz网址的截图
%\centerline{\includegraphics[height=6.58cm,width=6.11cm]{Figure/fig3.pdf}}
\centerline{\includegraphics[height=3.88cm,width=5.99cm]{Figure/fig3.pdf}}
%\centerline{\includegraphics[height=4.656cm,width=7.188cm]{Figure/fig3.pdf}}
