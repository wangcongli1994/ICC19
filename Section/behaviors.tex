\section{HTTPS ERRORS IN BROWSERS}
%这里要先写一段总结介绍的话
...
\begin{figure}[htbp]
\centerline{\includegraphics{fig1.png}}%记得换成chrome的截图
...
\begin{figure}[htbp]
\centerline{\includegraphics[height=3cm,width=7cm]{fig2.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[height=3cm,width=7cm]{fig3.png}}%记得换成自己fireblossom.xyz网址的截图
...
\begin{figure}[htbp]
\centerline{\includegraphics[height=3cm,width=7cm]{fig4.png}}%截图需要再调整成清晰的
